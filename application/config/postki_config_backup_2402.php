...
$config['proximity_in_meters'] = 800;
...
$config['access_layer'] = array(
    'edit_status' => array(2, 42, 43, 44, 45, 46, 47, 59, 54, 58, 65, 110, 97, 65, 116),
    'cancel_order' => array(2, 42, 43, 47),
    'luckydraw' => array(2, 42, 43),
    'miscellaneous' => array(2, 42, 43),
    'order_edit_status' => array(2, 42, 43, 54, 58, 103, 65),
    'shipment_batch_load_plan_edit' => array(2, 42, 43, 54, 58),
    'restore_EOD_status' => array(2, 42, 43),
    'commission_module' => array(2, 42, 43, 55),
    'passport_img_update' => array(2, 42, 43, 54, 58, 65, 158, 176, 177, 182, 157, 183, 184, 189, 190, 191),
    'mass_order_status_update' => array(2, 42),
);
...
$config['configurable_password'] = '123456';