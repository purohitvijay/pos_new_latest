        ...
        <div class="modal-body">
            <form class="form-horizontal" id="form_horizontal" action="#" enctype="multipart/form-data">
                <div class="form-outer div-center">
                    <!-- Form Name -->
                    <legend>Please enter following information</legend>
                    ...
                    <!-- file input-->
                    <div class="form-group">
                        <input id="passport" name="passport" placeholder="Passport" class="form-control input" required="" type="file">
                    </div>
                    <!-- Button -->
                    <div class="form-bottom">
                        <div class="form-group">
                            <button id="submit_button" name="submit_button" class="btn btn-primary" data-toggle="modal" href="result.php"><?= lang("uoload") ?></button>
                        </div>
                    </div>
                </div>
            </form>
...
$(document).ready(function (){
    ...
    $('#codeBoxSelect').change(function (){
        ...
        $('.passport_phont_link').click(".passport_img_update_model", function (){
...
//            });
    ...
    $('#selectCustomerButton').click(function (event){
            ...
            if(typeof(passport_img) !=  "undefined" && passport_img != "")
            {
            $('.passport_phont_link').html(`   <label for='textfield' class='control-label'>&nbsp;&nbsp;&nbsp;&nbsp;
                                                ...
                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                <a href='#' customer_id='${customerId}' customer_name='${nameValue}' id_number='${passport_id_number}' class='passport_img_update_model'>
