<div class="container-fluid">
    ...
    <div class="page-header">
        ...
        <div class="row">
            <form action="<?=base_url()?>admin/report/driverDeliverySheet" method="post">
                ...
                <div class="box box-color box-bordered">
                    <div>
                        <h3>
                            ...
                            Delivery Reports As Of <?=$delivery_date_from?> -  <?=$delivery_date_to?> <?=empty($driver_names) ? '' : 'for '.implode(', ', $driver_names)?>
                        </h3>
                    </div>
                    <?php
//                    p($records,0);
