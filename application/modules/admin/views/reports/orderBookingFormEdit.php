...
<?php
    ...
    ?>
                                                        ...
                                                        <button class="btn btn-primary btn-inverse" id="cancelOrderButton">
    ...
    <?php
                                                ...
                                                {
    ?>
                                                        <button class="btn btn-primary btn-inverse" rel="no" style="background-color:#339933" id="KIVOrderButton">
    ...
    <?php
                                                ...
                                                {
    ?>
                                                        <button class="btn btn-primary btn-inverse" rel="yes" id="KIVOrderButton">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body" style="height: auto">
            <img src="" alt="Passport photo" style="height: auto; width: 100%">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
      ...
      <div class="modal-header">
        ...
        <div class="modal-body">
            <form id="form_horizontal" role="form" action="#" enctype="multipart/form-data">
                ...
                <!-- Text input-->
                <div class="form-group">
                        <input id="id_number" name="id_number[]" placeholder="ID Number" class="form-control" required="" type="text">
                </div>
                <!-- file input-->
                <div class="form-group">
                    <input id="passport" name="passport[]" placeholder="Passport" class="form-control" required="" type="file">
                </div>                    
                <div class="modal-footer">
                   <button id="submit_button" name="submit_button" class="btn btn-primary" data-toggle="modal" href="result.php">uoload</button>
...
<script type="text/javascript">
    ...
    $('.passport_img_show_model_link').click(function (){
        ...
        $("#passport_img_show_model").find("img").attr("src",folder_path);
