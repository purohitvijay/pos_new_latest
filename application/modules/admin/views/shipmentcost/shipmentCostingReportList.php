<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="pull-right">
            <div class="right-btn-add"> <a href="<?php echo base_url(); ?>admin/shipmentcost/shipmentCostingReport?haveSideBar=0" class="btn default"><?php echo mlLang('lblAddNewBtn'); ?></a> </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
...
//          TableAdvanced.init();
        $('#menuTable').dataTable({
            ...
            "bLengthChange": true,
            "iDisplayLength": 20,
            "sAjaxSource": "<?php echo base_url(); ?>admin/shipmentcost/getShipmentCostingReportData", //datasource
            ...
            "aoColumns": [//tentukan kolom pd tabel dan value nya
                ...
                {"mDataProp": "shipment_batch", "sTitle": "Shipment Batch"},
                {"mDataProp": "shipment_reference", "sTitle": "Shipment Ref."},
                {"mDataProp": "date", "sTitle": "Date"},
                {"mDataProp": 'exchange_rate', "sTitle": "Exchange Rate"},
