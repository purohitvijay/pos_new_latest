            ...
            <div class="row">
                <form action="<?= base_url() ?>admin/shipmentcost/shipmentCostingReport" method="post">
                    <div class="pull-left form-group">
                        ...
                        <label for="exchange_rate" class="control-label pull-left">
                            &nbsp;&nbsp;Exchange Rate
                        </label>
                        <div class="pull-left" style="padding-left:10px">
                            <div class='input-group'>
                        ...
                        <div class="pull-left" style="padding-left:10px">
                            <div class='input-group date'>
                                <input type="text" name="shipment_reference" id="shipment_reference" class="form-control big" required value='<?= $shipment_reference ?>'>
                            </div>    
                        </div>
