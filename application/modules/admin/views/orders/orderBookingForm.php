                                            ...
                                            <div class="box-content nopadding" id="myForm">
                                                ...
                                                <div class="form-group">                                                    
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="checkbox" name="blacklistCustomer" value="1"  class="form-control searchFormClass <?php echo $disableClass;?>" <?php echo $disableClass;?> id="blacklistCustomer" style="-webkit-appearance: checkbox; width:15px;" <?php echo $readonly;?> />
                                                ...
                                                <div class="form-group">                                                    
                                                    ...
                                                    <div class="col-sm-4">
                                                        <textarea name="bcomments" <?php echo $readonly;?> id="b_comments" style="width:418px;height:83px" <?php echo $disableClass;?>  class='form-control <?php echo $disableClass;?>' placeholder="Comments"></textarea>
                                                    </div>
...
//                  alert(response.warning);
                    if(response.blacklist_user == false)
                    {
...
//            });
    ...
    $('#selectCustomerButton').click(function (event){
            ...
            var blacklist = $('#blacklist_' + customerId).val();
            var blacklist_comment = $('#blacklist_comment_' + customerId).val();
            if(blacklist == "Yes")
            {
            ...
            $("textarea#b_comments").text(blacklist_comment);
            ...
            $canBlacklistUser = canPerformAction('blacklist', $userId);  
            if($canBlacklistUser === FALSE)
            {
                ?>
                $('#blacklistCustomer').attr('disabled',"disabled");
                $("textarea#b_comments").attr('disabled',"disabled");
              <?php              
            }
