...
?>
                                                <tr class="<?php echo $class;?>">
                                                        ...
                                                        <input type="hidden" value="<?=$row['blacklist'];?>" id="blacklist_<?=$row['id'];?>">
                                                        <input type="hidden" value="<?=$row['blacklist_comment'];?>" id="blacklist_comment_<?=$row['id'];?>">
                                                        
                                                        <td id="mobile_<?=$row['id'];?>" class='hidden-350'><?=$row['mobile'];?></td>
                                                        <td id="residence_phone_<?=$row['id'];?>" class='hidden-350'><?=$row['residence_phone'];?></td>
                                                        <?php 
                                                        if($row['blacklist'] == "No" || $check_blacklist == true)
                                                        {?>
