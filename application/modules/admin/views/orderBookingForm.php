...
//            });
    ...
    $('#selectCustomerButton').click(function (event){
            ...
            if(typeof(passport_img) !=  "undefined" && passport_img != "")
                $('.passport_phont_link').html("<label for='textfield' class='control-label'>&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' path='"+passport_img+"' class='passport_img_show_model_link'>"+passport_id_number+"</a></label>&nbsp;&nbsp;&nbsp;&nbsp;<i class='fa fa-refresh'></i>");
