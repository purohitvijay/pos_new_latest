    ...
    <div class="page-header">
        ...
        <div class="row">
            <div class="pull-right">
                <div class="right-btn-add"> <a href="<?php echo base_url(); ?>admin/masters/add_category" class="btn default"><?php echo mlLang('lblAddNewBtn'); ?></a> </div>
            </div>
            <div class="col-sm-12">
...
//          TableAdvanced.init();
        $('#menuTable').dataTable({
            ...
            "bLengthChange": true,
            "iDisplayLength": 20,
            "sAjaxSource": "<?php echo base_url(); ?>admin/masters/get_categories_data", //datasource
            ...
            "aoColumns": [//tentukan kolom pd tabel dan value nya
                {"mDataProp": "category", "sTitle": "Name"},
