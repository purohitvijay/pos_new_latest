                    ...
                    <div class="box box-bordered box-color">
                            ...
                            <div class="box-content nopadding">
                                <form id="myForm" action="<?php echo base_url(); ?>admin/masters/addShipmentBatch" class="form-horizontal form-bordered" method='post' id="boxForm" name='boxForm'>
                                            ...
                                            <div class="form-group">
                                                    <label for="load_date" class="control-label col-sm-2">Load Date<span class="required">*</span></label>
                                                    <div class="col-sm-10">
                                                        <input type="text" id="load_date" class="form-control" placeholder="Load Date" id="load_date" name="load_date" value="<?php echo set_value('load_date', empty($load_date) ? "" : $load_date); ?>" style="width:11%" required/>
                                                    </div>
                                            </div>
