    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="bulkUpdateShipmentBatchStatusForm" method="post" action="#">
                <input type="hidden" name="shipment_batch_id" id="shipment_batch_id" >
                <div class="modal-body">
                        <div class="row">
                           <div class="col-lg-12">
                               Are you sure you want to Escalate Orders status?
                            </div>
                        </div>
                </div>
...
<script>
    $(document).ready(function () 
    {
        ...
        {
            e.preventDefault();
            var data_shipment_batch_id = $(this).attr('data_shipment_batch_id')
            $('#shipment_batch_id').val(data_shipment_batch_id);
        ...
        function initTables()
        {
            ...
            $('#menuTable').dataTable({
                ...
                "bDestroy": true,
                "bLengthChange": true,
                  <?php if($this->config->item('set_query_result') == 0)
                    {
                        ?>
                    "iDisplayLength": -1,
                            <?php 
                    ...
                    {
                    ?>
                    "iDisplayLength": <?php echo $this->config->item('set_query_result');?>,
                    <?php } ?>  
//                "iDisplayLength": 20,
    ...
    //                {"mDataProp": "shipment_report", "sTitle": "Report", "bSortable": false}
            ...
            {
                ?>
                [<?php echo $this->config->item('set_query_result');?>,20, 50, 100, -1],
                [<?php echo $this->config->item('set_query_result');?>,20, 50, 100, "All"],
            <?php            
            }
            else
            {
