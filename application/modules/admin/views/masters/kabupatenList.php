    ...
    <div class="page-header">
        ...
        <div class="row">
            <div class="pull-right">
                <div class="right-btn-add"> <a href="<?php echo base_url(); ?>admin/masters/addKabupaten/<?=$location_id?>" class="btn default"><?php echo mlLang('lblAddNewBtn'); ?></a> </div>
            </div>
            <div class="col-sm-12">
...
//          TableAdvanced.init();
        $('#menuTable').dataTable({
            ...
            "bLengthChange": true,
            "iDisplayLength": 20,
            "sAjaxSource": "<?php echo base_url(); ?>admin/masters/getKabupatenData/<?=$location_id?>", //datasource
